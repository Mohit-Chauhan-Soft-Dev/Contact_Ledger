...
public class PageController {
    ...
    // This method processes the signup form submission
    @PostMapping("/do_signup")
    public String do_signup(@Valid @ModelAttribute UserForm userForm, BindingResult result, HttpSession session) {
